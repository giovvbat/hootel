...
public class GerenteInformacoesCruzeiroController {
    private final InformacoesService informacoesService;

    @Autowired
    public GerenteInformacoesCruzeiroController(InformacoesService informacoesService) {
