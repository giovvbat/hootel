...
public class GerenteReservaCruzeiroController {
    private ReservaService reservaService;

    public GerenteReservaCruzeiroController(ReservaService ReservaService) {
    ...
    public List<Reserva> populateReservas(Model model) {
        try {
            return reservaService.lerTodasReservas(ReservaCruzeiro.class);
    ...
    public String mostrarReservas(Model model){
        ...
        return "cruzeiro/reservas_gerente";
    }

    @PostMapping("/addReserva")
    public String criarNovaReserva(Model model) {

        Reserva reserva = reservaService.criarReserva(new ReservaCruzeiro());
        model.addAttribute("novaReserva", reserva);

        return "redirect:/cruzeiro/mostrarReservas";
    }

    @PostMapping("/removeReserva")
    public String removeReserva(@Valid @ModelAttribute("reserva") ReservaCruzeiro reserva,
